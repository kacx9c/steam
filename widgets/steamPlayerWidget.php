...
class _steamPlayerWidget extends \IPS\Widget\StaticCache
{
	...
	public function configuration( &$form=null )
	{
		...
		$form->add( new \IPS\Helpers\Form\Number( 'steamIndexCount', isset( $this->configuration['steamIndexCount'] ) ? $this->configuration['steamIndexCount'] : 5, TRUE) );
		$form->add( new \IPS\Helpers\Form\YesNo( 'steamIndex2weeks', isset( $this->configuration['steamIndex2weeks']) ? $this->configuration['steamIndex2weeks'] : TRUE ) );
	...
	public function render()
	{
		...
		$limit	= array( 0, (isset( $this->configuration['steamIndexCount'] ) ? $this->configuration['steamIndexCount'] : 5 ) );
