...
class _Steam
{
	...
	{
		$form->add(new \IPS\Helpers\Form\YesNo('steam_pull', (isset($group->steam_pull) ? $group->steam_pull : TRUE)));
		$form->add(new \IPS\Helpers\Form\YesNo('steam_index', (isset($group->steam_index) ? $group->steam_index : TRUE)));
	}
